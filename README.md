...
Seu desafio é criar essa seção de recursos e fazer com que ela fique o mais próxima possível do design.
...
-   **URL do Repositório:** [https://github.com/alex-coder27/four-card-feature-section-master]
-   **URL do Site ao Vivo:** [https://alex-coder27.github.io/four-card-feature-section-master]
...
1.  **Clone o repositório (se estiver em um):**
    ```bash
    git clone https://github.com/alex-coder27/four-card-feature-section-master.git
    ```
